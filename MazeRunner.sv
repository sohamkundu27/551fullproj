module MazeRunner(
  ...
  navigate #(FAST_SIM) iNAV(.clk(clk),.rst_n(rst_n),.strt_hdng(strt_hdng),.strt_mv(strt_mv),
	...
	//assign LED[7:1] = frwrd_spd[8:4];
	// assign LED[7:1] = IR_diff[11:5];
	// assign LED[7:1] = lft_IR[11:5];
	//  assign LED[7:1] = rght_IR[11:5];
	 assign LED[6:1] = 6'h00;
	 assign LED[7] = sol_cmplt;
	//assign LED[7:1] = IR_Dtrm[8:2];
	// assign LED[1] = frwrd_opn;
