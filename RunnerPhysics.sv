module RunnerPhysics(clk,RST_n,SS_n,SCLK,MISO,MOSI,INT,lftPWM1,lftPWM2,rghtPWM1,rghtPWM2,
  ...
  input SS_n;				// active low secondary select to inertial sensor
  input SCLK;				// Serial clock
  input MOSI;				// serial data in from main
  ...
  input A2D_SS_n;			// active low secondary select for A2D model
  ...
  initial begin
	...
	xx = 15'h3800;			// start 3.5 squares from left
	yy = 15'h3800;			// start 3.5 squares up.
	magnet_pos_xx = 7'h18;	// magnet pos is middle of (1,2)
	magnet_pos_yy = 7'h28;
